...
public sealed class SpellSectionController
{
    ...
    public void Bind(VisualElement spellsPanel, ScreenSwapper swapper)
    {
        ...
        _active.Bind(_panelRoot, unlockedSlots: _unlockedActiveSlots, _screenSwapper);

        _list.IsDraggingSpell = () => _isDraggingSpell;
        _active.IsDraggingSpell = () => _isDraggingSpell;
        ...
        _drag = new SpellDragController(
            ...
            onDragStarted: OnSpellDragStarted,
            onDragEnded: OnSpellDragEnded
        );
    ...
    private void OnSpellDragStarted()
    {
        ...
        var spellTooltip = _screenSwapper.GetCustomTooltipElement("SpellDetailTooltip");
        if (spellTooltip != null)
            _screenSwapper.HideCustomTooltip(spellTooltip);
        _screenSwapper.HideTooltip();
    }

    private void OnSpellDragEnded()
    {
        _isDraggingSpell = false;
    }
