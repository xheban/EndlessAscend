...
public sealed class SpellsListSectionController
{
    ...
    public void RebuildList()
    {
        ...
        foreach (var spellId in ownedSpellIds)
        {
            ...
            // ✅ Important: prefer the actual root inside template named "Row"
            ...
            if (setActiveBtn != null)
            {
                ...
                {
                    // If it becomes enabled again, ensure tooltip disappears if it was showing
                    // (no harm calling HideTooltip even if it wasn't visible)
